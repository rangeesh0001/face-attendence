    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'D:/attendence/Face-Recognition-Attendance-System-mainAttendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"D:/attendence/Face-Recognition-Attendance-System-mainAttendance/Attendance\Manually Attendance\-------Check atttendance-------"')
